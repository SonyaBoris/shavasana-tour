                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur shadow-lg">
                        ...
                        <ul className="space-y-3 text-base leading-relaxed text-white/90 list-disc marker:text-white/70 pl-5">
                            ...
                            <li>Завтраки, занятия йогой и ежедневные брифинги</li>
                            ...
                            <li>Мы попадем на красивейший пляж Радха Нагар, где снимали эпизод фильма Пираты карибского моря</li>
                            <li>Ночной каякинг, снорклинг и дайвинг</li>
                        </ul>
                    </div>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur shadow-lg">
                        ...
                        <ul className="space-y-3 text-base leading-relaxed text-white/85 list-disc marker:text-white/70 pl-5">
                            ...
                            <li>Обеды и ужины</li>
                            <li>Страховка, виза</li>
                            <li>Консультация Михаила оплата Донейшн (по сердцу)</li>
                        </ul>
                    </div>
                </div>
